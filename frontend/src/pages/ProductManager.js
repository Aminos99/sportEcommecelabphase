...
function ProductManager() {
    ...
    useEffect(()=>{
        const getAllproducts = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_LINK_URL}/api/products/`)
    ...
    const addProduct = async (e) => {
        ...
        try {
          const response = await axios.post(`${process.env.REACT_APP_LINK_URL}/api/products/addProduct`, {
            name,
            description,
            price,
            category,  
    ...
    const handleUpdateProduct = async (e) => {
        ...
        try {
          const res = await axios.put(`${process.env.REACT_APP_LINK_URL}/api/products/${editingProductId}`, {
            name,
            description,
            price,
            category,
      ...
      const handleDeleteProduct = async (productId) => {
        ...
        try {
          await axios.delete(`${process.env.REACT_APP_LINK_URL}/api/products/delete`, {
            headers: {
